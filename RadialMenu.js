...
inherit(UIRadialMenuEntry, UIElement);

UIRadialMenuEntry.prototype.on_mousedown = function(MouseEvent event) {
...
UIRadialMenuEntry.prototype.on_mouseup = function(MouseEvent event) {
...
UIRadialMenuEntry.prototype.build_draw = function(UICanvas canvas) {
  canvas.begin(this);
...
UIRadialMenuEntry.prototype.get_min_size = function(UICanvas canvas, Boolean isvertical)
{
...
UIRadialMenu.prototype.on_keydown = function(KeyboardEvent event) {
...
UIRadialMenu.prototype.end_menu = function(do_callback) //do_callback is optional, false
{

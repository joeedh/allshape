...
Element.prototype.pack = function(Array<byte> data) {
...
Vertex.prototype.pack = function(Array<byte> data) {
...
Edge.prototype.pack = function(Array<byte> data) {
  Element.prototype.pack.call(this, data);
...
Loop.prototype.pack = function(array<byte> data) {
  pack_int(data, this.eid);
...
function LoopList(Loop loop) {
  ...
  this.__iterator__ = function() : LoopIter {
...
Face.prototype.pack = function(Array<byte> data) {
  Element.prototype.pack.call(this, data);
...
function EIDGen() {
  ...
  this.get_cur = function(cur) : int {
    return this.cur_eid;
  }
  
  this.gen_eid = function() : int {
    return this.cur_eid++;
  }
}
...
function Mesh() {
  ...
  this.pack = function(Array<byte> data) {

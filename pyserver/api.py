...
from fileapi import FileAPI_MakeFolder, FileAPI_DirList, FileAPI_GetMeta, FileAPI_UploadStart, FileAPI_UploadChunk, FileAPI_GetFile

api_handlers = {
  "/api/files/dir/list"     : FileAPI_DirList,
  "/api/files/get/meta"     : FileAPI_GetMeta,
  "/api/files/get"          : FileAPI_GetFile,
  "/api/files/dir/new"      : FileAPI_MakeFolder,

...
inherit(InsetOp, TransformOp);

InsetOp.prototype.can_call = function(ctx) {
  var totsel = 0;
...
InsetOp.prototype.end_modal = function() {
...
InsetOp.prototype.modal_init = function(ctx) {
...
InsetOp.prototype.find_loops = function(ctx) {
  var vdone = new set();
...
InsetOp.prototype.cancel = function(ctx) {
  var td = this.transdata;
...
InsetOp.prototype.on_mousemove = function(event) {
...
InsetOp.prototype.exec = function(ctx) {
  if (!this.is_modal) {
    this.transdata = new TransData(ctx);
    this.find_loops(ctx);
  }
